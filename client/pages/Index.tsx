      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-brand-dark-red via-black to-gray-600 border-b border-black shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-4 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-6 text-white font-poppins font-medium text-lg">
            <Link to="/" className="text-brand-accent hover:text-white transition">Home</Link>
            <Link to="/accessories" className="hover:text-brand-accent transition">Accessories</Link>
            <Link to="/part-finder" className="text-red-600 hover:text-white transition">Part Finder</Link>
            <Link to="/contact" className="hover:text-brand-accent transition">Contact Us</Link>
          </nav>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-brand-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {[
              { name: "Spectre Dual Mod Led HeadLight", img: "https://api.builder.io/api/v1/image/assets/TEMP/5e26cd5563fb34396c4ea7d7fb709d5e387e85a8?width=764" },
              { name: "Race Grade Sintered Brake Pads", img: "https://api.builder.io/api/v1/image/assets/TEMP/7c7b5151cf1f0c22972ece6ce7ec85b9a00fdffb?width=764" },
              { name: "Race Pro Full Synthetic Engine Oil", img: "https://api.builder.io/api/v1/image/assets/TEMP/614e08a721df4a87358da0fa02e76271722c99e0?width=770" }
            ].map((product, idx) => (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap justify-center gap-4">
              {["Part Finder", "Live Chat & Inquiry Support", "Customization & Upgrades"].map((feature) => (
                <button 
                  key={feature}
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {["Order Tracking & Fast Delivery", "Suspension Upgrades", "Customer Account Portal"].map((feature) => (
                <button 
                  key={feature}
                  className="bg-brand-gray text-white font-poppins font-semibold text-lg sm:text-xl lg:text-2xl px-6 py-3 shadow-2xl hover:bg-brand-red transition-all duration-300"
                >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {[
              ...
              <div key={idx} className="bg-brand-card p-6 rounded-lg hover:shadow-xl hover:shadow-brand-red/30 transition-all duration-300">
                ...
                <img src={service.icon} alt={service.title} className="w-32 h-32 mx-auto mb-4 object-contain" />
                <p className="text-sm font-montserrat bg-gradient-to-b from-purple-900 to-gray-500 bg-clip-text text-transparent mb-4">
                  {service.desc}
                </p>
                <a href="#" className="text-brand-accent font-poppins font-medium text-sm hover:underline inline-flex items-center gap-1">
                  Get The Offer
            ...
            {[
              ...
              <div 
                ...
                className={`bg-gray-400 rounded-lg overflow-hidden shadow-lg hover:shadow-brand-red/50 transition-all duration-300 ${
                  idx === 0 || idx === 3 || idx === 4 ? 'col-span-2 row-span-2' : ''
                }`}
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-brand-card rounded-lg overflow-hidden shadow-lg hover:shadow-brand-red/30 transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm font-montserrat text-gray-400 mb-2">
                    {post.desc}{" "}
                    <a href="#" className="text-brand-accent hover:underline">[See more]</a>
                  </p>
                </div>
              </div>
            ))}
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-brand-dark">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <p className="text-brand-accent font-montserrat font-medium text-xl sm:text-2xl md:text-3xl text-center mb-12 max-w-2xl mx-auto">
            Exemplary craftsmanship, seamless experiences, and innovative solutions
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-12">
            {[
              ...
              <div key={idx} className="bg-brand-card p-6 rounded-lg shadow-lg hover:shadow-brand-red/30 transition-all duration-300">
                ...
                <div className="w-32 h-32 sm:w-44 sm:h-44 mx-auto mb-6 relative">
                  <svg className="w-full h-full" viewBox="0 0 176 176" fill="none">
                    <path 
                      opacity="0.971" 
                      fillRule="evenodd" 
                      clipRule="evenodd" 
